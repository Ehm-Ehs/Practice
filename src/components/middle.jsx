...
function Middle() {
  ...
  const [writeups, setWriteups] = useState([
    ...
    {src: middle2img , title:'Flexible Workflow Model' ,body: ' AOS flexible workflow model gives you the ability to define\n automated workflow rules that match your business practices. The system conforms to general agricultural practices',bg:secondbg,id:2},
    {src: middle3img , title:'Highly Adaptable,Enterprise-Class Applications',body: 'AOS delivers a broad set of interated Agriculture business\nfunctionality on a highly adaptable platform.Role-based management dashboard with drill-down capability allow you to effectively monitor and analyse your operators and pre-built charts and graph can be easily expanded to meet your specific needs',bg:firstbg,id:3},
   ])
